...
export function AddDatasetPage() {
    ...
    const handleAddSample = () => {
        let newSample: DatasetSample | null = null
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault()
        if (validateForm()) {
            // In a real app, this would be an API call to save the dataset
            console.log('Dataset to submit:', dataset)
    ...
    const renderSampleInput = () => {
        switch (dataset.format) {
            ...
            // Default case for TEXT and others
            default:
                return (
                    <div className="space-y-3">
                        <div>
    ...
    const renderSampleDisplay = (sample: DatasetSample) => {
        switch (dataset.format) {
            case DatasetFormat.IMAGES:
            case DatasetFormat.AUDIO:
                return (
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        onChange={(e) => {
                                            ...
                                            // Reset any format-specific errors
                                            if (errors.jsonSample) {
                                                const { jsonSample, ...restErrors } = errors
                                ...
                                <div className="bg-white border border-gray-200 rounded-lg p-4 mb-4">
                                    ...
                                    <div className="flex items-baseline mb-3">
                                        ...
                                        <span className="text-gray-500 ml-1">
                                            {dataset.purchasePlan.billingPeriod !==
