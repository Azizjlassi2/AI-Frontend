...
export function DeveloperDashboardPage() {
    ...
    const models = [{
        ...
        endpoints: [
            ...
            { env: "Staging", url: "https://stg-api.aiplus.tn/v1/medtun-cxr" }
        ],
        stats: {
            calls: "45K/mois",
            revenue: "€1,240",
                                        ...
                                        <div className="space-y-2">
                                            {model.endpoints.map((endpoint, i) => (
                                                <div key={i} className="flex items-center bg-gray-50 p-3 rounded">
                                                    ...
                                                    <span className="ml-4 text-sm text-gray-500">{endpoint.env}</span>
                                                </div>
                                            ))}
                                        </div>
                                    </div>
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-8">
                    <div className="bg-white rounded-xl shadow-sm p-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <Link to={`/subscriptions/new`} className="w-full border-2 border-blue-600 text-blue-600 px-4 py-2 rounded hover:bg-blue-50">
                                + Ajouter un plan
                            </Link>
                        </div>
                    </div>
