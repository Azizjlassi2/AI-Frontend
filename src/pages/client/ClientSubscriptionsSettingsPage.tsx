...
import { ArrowLeft, CreditCard, Bell, Calendar, RefreshCw, AlertTriangle, CheckCircle, XCircle, Download, BarChart2, Settings, Trash2, Save, Zap } from 'lucide-react';
...
export function SubscriptionSettingsPage() {
            ...
            <div className="container mx-auto max-w-3xl">
                <div className="bg-white rounded-xl shadow-sm p-8">
                    <div className="flex flex-col items-center justify-center py-12">
                        ...
                        <Link to="/client/subscriptions" className="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 flex items-center">
    ...
    return <div className="min-h-screen bg-gray-50 p-8">
        <div className="container mx-auto max-w-3xl">
            ...
            <div className="mb-6">
                <Link to="/user/subscriptions" className="text-blue-600 hover:text-blue-800 flex items-center">
                    <ArrowLeft className="h-4 w-4 mr-2" />
                    Retour aux abonnements
                </Link>
            </div>
