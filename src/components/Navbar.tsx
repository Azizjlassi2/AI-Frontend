              ...
              <div className="relative">
                ...
                {isDropdownOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-white border rounded-lg shadow-lg">
                    <Link to={role === "ROLE_CLIENT" ? "/client/dashboard" : "/dev/dashboard"} className="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                      Dashboard
                    </Link>
                    <Link to={role === "ROLE_CLIENT" ? "/client/settings" : "/dev/settings"} className="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                      Settings
                    </Link>
